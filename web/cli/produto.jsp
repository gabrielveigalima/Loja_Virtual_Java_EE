...
<%
    //Pega o Id do curso pelo método get
    String id = request.getParameter("idCurso");
    //Instancia a classe e o método passando o paramento  
                            ...
                            <div class="col-sm-6">
                                <div class="box">
                                    ...
                                    <form>
                                        ...
                                        <p class="text-center">
                                            <button type="submit" class="btn btn-template-main"><a href="cadCarrinho.jsp?id=<%=cs.getId()%>"><i class="fa fa-shopping-cart"></i> Adicionar ao carrinho</a></button>
